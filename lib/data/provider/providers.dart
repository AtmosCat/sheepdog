...
final subscriptionServiceProvider = ChangeNotifierProvider<SubscriptionServiceViewModel>(
  create: (_) => SubscriptionServiceViewModel(),
);

// 구독 카테고리 ViewModel Provider
final subscriptionCategoryProvider = ChangeNotifierProvider<SubscriptionCategoryViewModel>(
